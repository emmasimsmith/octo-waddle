    ...
    if (count($errors) != 0) {
        ...
        <html>
          ...
          <body>
            ...
            <br>
            <form action = <?php echo "editsailing.php?event_id=$event_id&activity_id=$activity_id&class_id=$class_id method='POST'>";
    ...
    foreach ($sort as $unit_id => $score) {
        ...
        if ($count == 0) {
            ...
            if (mysqli_num_rows($race) == 0) {
                ...
                updatesailing($conn, 'completed', 100, $score, $race_id);
            }
        } else {
            ...
            if (mysqli_num_rows($race) == 0) {
                ...
                $race_id = $race_row['race_id'];
                //insert value into table
                updatesailing($conn, 'completed', $placescore, $score, $race_id);
            }
    ...
    while ($completed = mysqli_fetch_assoc($result)) {
        ...
        if ($_POST["$unit_id"] == "DNC") {
            ...
            if (mysqli_num_rows($race) == 0) {
                ...
                $race_id = $race_row['race_id'];
                //update
                updatesailing($conn, 'DNC', $placescore, 'NULL', $race_id);
            }
        }
    }
