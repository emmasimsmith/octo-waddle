...
if (mysqli_num_rows($result) != 0) {
    //if activity has already been made, go to edit lifesaving page
    header("Location: editlifesaving.php?event_id=$event_id&activity_id=$activity_id&class_id=$class_id");
    ...
    if (count($errors) != 0) {
        ...
        <html>
          ...
          <body>
            ...
            <br>
            <form action = <?php echo "lifesaving.php?event_id=$event_id&activity_id=$activity_id&class_id=$class_id method='POST'>";
    ...
    tied($conn, $event_id, $activity_id, $class_id);
