...
function input($conn, $activity_id, $unit_id, $result, $calculated_score, $original_score, $event_id)
{
...
function updateseamanship($conn, $result, $calculated_score, $original_score, $race_id)
{
...
function race_id($conn, $event_id, $activity_id, $unit_id)
{
